...
var BLURRED_SIZE = 128;
var BLURRED_AMOUNT = 5;
...
var configFor = (source) => {
  ...
  const blurAmount = source?.blurAmount ? source.blurAmount : defaultConfig?.blurAmount || BLURRED_AMOUNT;
  const blurSize = source?.blurSize ? source.blurSize : defaultConfig?.blurSize || BLURRED_SIZE;
